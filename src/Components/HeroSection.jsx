...
const HeroSection = () => {
  return (
    <>
    <div className="hero-background h-[730px] w-full m-auto">
            <div className="text-center pt-20">
                <p className="text-gray-600 px-3 py-1 border border-[#222222] inline-block rounded-lg">Version 2.0 is here <span className="text-white">Read more 
                    <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
