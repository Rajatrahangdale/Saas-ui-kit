      ...
      <div className="hero-background h-auto w-full m-auto">
        ...
        <div>
          ...
          <div className="text-center text-white md:mt-[50px] mt-10 text-lg">
            ...
            <button className="text-center bg-white rounded-2xl py-2 px-4 text-black relative md:top-[96px] top-[70px] z-10 active:translate-x-1 active:translate-y-1 duration-300 hover:ease-in-out active:bg-[#4F21A1] active:text-white">
              Get for free
            </button>
          </div>
        </div>
        <div className="md:relative hidden md:block">
          <div className="md:absolute md:-top-96 md:-left-5 lg:-top-72 lg:left-[270px]">
            <img src={Cursor} alt="cursor" />
          </div>
          <div className="md:absolute md:-top-[350px] md:left-[600px] lg:-top-96 lg:left-[900px]">
